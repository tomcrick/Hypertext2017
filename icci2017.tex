...
This graph include 63 langauge communities, 15 languages exist as profile only and
...
relationships exist as 'self-loop', which we covered in \ref{communitiesgraph}.

Removing self-loop edges will make realtionships between language communities 
clearer. 
...
The following table shows some obseravtions on this group.
