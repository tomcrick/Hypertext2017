...
\subsubsection{Communities Graph}
...
Refering to the example in Figure~\ref{fig:graphstructures}, we can see that 
...
This is to measure posting languages. Taken from communities graph: number of nodes with indegree \textgreater 0 .
