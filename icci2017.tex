...
two nodes, one represents the user with profile language setting 
added to the node as the attribute '{\emph{\{profile\_lang:xx\}}}'. The other node 
...
In the example above, the profile language setting for user '0123' is 'en', posted 3 tweets in 
'en' and 4 in 'ar'.

In this section, we will present how  of language communities begins with two basic techniques. The
first is to classify Language used in posting defines which community the
