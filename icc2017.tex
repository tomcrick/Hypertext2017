...
by many commentators to be tense and politcally motivated [16],
especially with Ukraine eventually winning the final. Although some
articles do not see the contest as influenced by political conflicts
or friendship~\cite{ginsburgh+noury:2008}[18], some recent news articles articulate on the
possibly biased results[19].  The activity on Twitter was also very
high throughout the event using Eurovision hashtag as the main
tag. The size of participation collected exceeded 7,900,000
statuses. The activity was produced from 1,226,959 users. Figure 1
below, shows the overall activity on Twitter.
