...
\begin{abstract}
In this paper we present our analysis of online interactions that took
place on the social networking site Twitter during the Baltimore
protests in April 2015. While little is currently known about the
factors that promote the propagation of information in online social
networks following significant events, such as rioting and terrorism,
this paper evaluates the extent to which different language
communities engage and interact. By utilising language information
from user profiles ({\emph{N}}=716,494) and status updates
({\emph{N}}=1,250,000) relating to the Baltimore protests to
...
network graphs. The results show that the nature of the event is
reflected on the engagement degree and wider interaction of
communities. This analysis of language communities may also help in
deciding which group of users to engage with, and hence increase the
chance of influential action when participating on Twitter
conversations.
\end{abstract}
...
such as Twitter, Facebook and YouTube have created (generally) open
digital platforms that have empowered global citizens to promote their
ideas, work and themselves to a diverse international audience. The
engagement of certain demographies of society with social networks
offers the exciting opportunity for researchers interested in
observing and interpreting society to apply established theory and
methods to an emerging online culture. With over a billion active
users, social networks are producing massive amounts of data (volume)
on a real-time basis (velocity) with implicit sociological attributes
such as belief, opinion, behaviour, societal structure and influence
(variety)~\cite{burnap-et-al:2015}. These data exhibit the key traits
of what is often referred to as big data: volume, velocity and
variety~\cite{postsm:2014}. Behaviour and interaction have been
empirically studied for centuries by social scientists, with
rigorously applied methods and analyses being developed to yield
meaningful results. In the age of big data and the increasingly
interconnected online and digital society, there is a new challenge --
to support the development of interoperable and scalable methods and
tools that can be applied to digitised social behaviour produced via
social networks -- or analysing big social data to provide insight
into real-world events and
...
has analysed what people say on social media to find distinctive
...
governmental institutions, or even one's Twitter followers or Facebook
friends could use software to infer personality (and other attributes,
such as sexual orientation or political affiliations) that an
individual may not have intended to
...
him.}}''~\cite{baltimorewiki:2015}. The nature of the Baltimore riots
