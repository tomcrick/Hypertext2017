...
profile communities. Moreover, the techniuqe can be 
narrowed down to individual users. 
...
own (profile language), same-language communities are filtered out. As we can see 
